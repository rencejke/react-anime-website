...
<div className="content-item-1 relative">
 <div className="content-image">
    <img src="../../public/img/tv-1.jpg" alt="" className='rounded-md h-[220px] object-cover'/>
 </div>
 ...
 <div className="content-views absolute top-3  right-2 text-[14px]">
    <div className='flex gap-1 items-center bg-gray-500 px-3 py-1'>
    <FaEye />
...
<div className="content-item-2 relative">
 <div className="content-image">
    <img src="../../public/img/tv-2.jpg" alt="" className='rounded-md h-[220px] object-cover'/>
 </div>
...
<div className="content-item-3 relative">
 <div className="content-image">
    <img src="../../public/img/tv-3.jpg" alt="" className='rounded-md rounded-md h-[220px] object-cover'/>
 </div>
...
<div className="content-item-4 relative">
 <div className="content-image">
    <img src="../../public/img/tv-2.jpg" alt="" className='rounded-md w-[100%] h-[220px] object-cover'/>
 </div>
...
<div className="content-item-5 relative">
 <div className="content-image">
    <img src="../../public/img/tv-3.jpg" alt="" className='rounded-md rounded-md h-[220px] object-cover'/>
 </div>
